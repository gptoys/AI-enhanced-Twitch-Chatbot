...
To prompt a GPT-3 completion, simply type !ai `<prompt>` in the Twitch chat. The bot will respond with a completion generated by GPT-3. For instance, if you type `!ai The quick brown fox jumps over the lazy dog`, the bot might respond wit